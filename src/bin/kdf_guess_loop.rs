...
use mces::mces::thermo_harden_okm;
use std::time::Instant;

fn kdf_mces_okm(password: &str, salt32: &[u8; 32], t_cost: u32, m_cost: u32, lanes: u32, use_thermo: bool) -> Vec<u8> {
...
fn main() -> Result<()> {
    ...
    for i in 0..guesses {
        ...
        let okm = kdf_mces_okm(&pw, &salt32, t_cost, m_cost, lanes, use_thermo);
